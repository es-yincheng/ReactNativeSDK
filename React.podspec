...
source = { :git => 'git@github.com:es-yincheng/ReactNativeSDK.git' }
if version == '1000.0.0'
...
Pod::Spec.new do |s|
  ...
  s.author                  = "wyyincheng@163.com"
  s.source                  = source
  s.default_subspec         = ['Core','CxxBridge','DevSupport','RCTText','RCTNetwork','RCTWebSocket','RCTAnimation']
  s.requires_arc            = true
